namespace Northwind.Sales.Entities.Dtos.CreateOrder;
    ...
    //    string shipCountry, string shipPostalCode, IEnumerable<CreateOrderDetailDto> ordenDetails)
    //{
    //    public string CustomerId => customerId;
    //    public string ShipAddress => shipAddress;
    //    public string ShipCity => shipCity;
    //    public string ShipCountry => shipCountry;
    //    string ShipPostalCode => shipPostalCode;
    //    public IEnumerable<CreateOrderDetailDto> OrderDetailS => ordenDetails;
    //}
    ...
    //    public IEnumerable<CreateOrderDetailDto> createOrderDetailDtos
    //    {
